...
Also, check out Clang-Format, Prettier, or a similar formatting tool in order to
make tidying up your scripts much easier when working on large projects or group
projects
